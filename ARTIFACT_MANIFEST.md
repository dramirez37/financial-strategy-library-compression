...
| `manuscript/figures/unified_economic_geometry.tex` | `julia/scripts/generate_figure_audit_artifacts.jl` | `unified_elasticity_switching_v1.toml` and exact capacity/penalized-path CSVs | `Rational{BigInt}`; rendered coordinates | `bf8cb4f4da524a03dab32100d1698861211aeed9617d31a696f622eeab7020b2` | PUBLIC GENERATED; main paper |
...
| `release/v0.1.0-preprint/financial-strategy-library-compression-preprint.pdf` | `manuscript/build.sh` | committed main-paper source graph and bibliography | not applicable; compiled presentation of separately classified evidence | `f445d36a7da6fd0504d8cbe6786cd4295576489a7b4b4a36d0cb3ef8a75bccc4` | PUBLIC GENERATED; final 44-page release PDF |
| `release/v0.1.0-preprint/financial-strategy-library-compression-online-supplement.pdf` | `manuscript/online_supplement/build.sh` | committed supplement source graph and public generated inputs | not applicable; compiled presentation of separately classified evidence | `8c00eae258ff7a1d30b86ef5ffce26adc1b18f8f3598d9a778ee247cf7a569f7` | PUBLIC GENERATED; final 41-page release PDF |
...
| `UCS-TEST-v1` | `julia/test/test_comparative_statics.jl` | `735e2fc076259c188551aab4153b4ceb32faa058066858e75d2aa15180d33535` | exact/raw routing, exact-fixture, sparse-gate, sign-boundary, determinism, output, and artifact-drift checks |
...
| `UES-CODE-v1` | `julia/scripts/run_unified_elasticity_switching_experiment.jl` | `22fe30b0bddc6341f6d5fa6899feb186ebff61b7cd14912f2599f75e8e796032` | exact bridge, fixed-policy derivative, curvature, robustness, resource-path, CSV/JSON/SVG, and nonmutating drift runner |
...
| `UES-CAPACITY-v1` | `experiments/results/summaries/unified_elasticity_switching_v1_capacity.csv` | `79eed7b19cb99eef994ee78fb78408e73712e5185b6efac1fb1da8dc341b0ca9` | 30 exact attainable-capacity optimizers, shadows, elasticities, and enumeration certificates |
| `UES-PENALTY-v1` | `experiments/results/summaries/unified_elasticity_switching_v1_penalized_path.csv` | `9fd0cbe51d1dc3d5c8a49994c57e4fc6164abcd6a3b35bb6877414876b9d64cf` | 24 exact breakpoint/open/terminal price cells with complete optimizer ties and selected actions |
...
| `UES-FIG-CAPACITY-v1` | `manuscript/figures/unified_elasticity_switching_v1_value_capacity.svg` | `f214e95649cf96b3c2cf89e2a0bef2489a5ccbed7455cc9f0023a8f3c2c6ccbb` | exact-source value--capacity stairs; visually inspected |
| `UES-FIG-ENVELOPE-v1` | `manuscript/figures/unified_elasticity_switching_v1_penalized_envelope.svg` | `483cf5491175faef7680d5277604c5e077c3494fbe9249265d8370390a2874cc` | exact active affine penalty branches; visually inspected |
| `UES-FIG-BURDEN-v1` | `manuscript/figures/unified_elasticity_switching_v1_selected_burden.svg` | `ce022546c6c62dbe66d05770f3832f693d86dbae3a6a6d482249170593a0a6e8` | exact-source weakly decreasing burden paths; visually inspected |
...
| `ALC-REPORT-v1` | `APPROXIMATE_COMPRESSION_REPORT.md` | `a5e3d148603d3123614be6e453def500daff901c0a91758f4dfd51dc230854c8` | answer-first technical report with definitions, methods, findings, validation, limitations, and explicit numerical-only boundary |
...
| `UB-RESOURCE-FIG-CAP-v1` | `manuscript/figures/unified_canonical_resource_value_capacity.svg` | `ef820f74a5e32f77534f669cf27e74ee4cf7689244c61953ad74d4159011334e` | visually inspected two-belief right-continuous value--capacity curve with exact-source tooltips and distinct preregistered schedule styles |
| `UB-RESOURCE-FIG-PRICE-v1` | `manuscript/figures/unified_canonical_resource_value_price.svg` | `2f182595fb1cc8a3b827575f84ded2187418c8bc44294db639b091c40e49f5d0` | visually inspected two-belief penalized-value envelope sampled only for secondary display from exact affine branches |
| `UB-RESOURCE-FIG-PATH-v1` | `manuscript/figures/unified_canonical_resource_library_path.svg` | `a1b1dfca54cc693274eaabf8bd94f4c6a83ff7da75901070138a7c962c25ea62` | visually inspected capacity-optimal library path under the declared minimum-burden/lowest-mask display selection |
...
| `FIG-AUDIT-CODE-v1` | `julia/scripts/generate_figure_audit_artifacts.jl` | `049b44a7644dd415efc82d0a1e77dbf6aa1d4f22ed18ac04649a01781c3a5318` | exact-source Julia renderer for the bridge and combined economic geometry; validates fixture identities, optimizer completeness, and tie completeness and supports nonmutating `--check` |
...
| `FIG-AUDIT-GEOMETRY-v1` | `manuscript/figures/unified_economic_geometry.tex` | `bf8cb4f4da524a03dab32100d1698861211aeed9617d31a696f622eeab7020b2` | six-facet main-text economic geometry generated from exact capacity and penalized-path rows; uses right-continuous stairs, exact affine branches, and open/filled exact tie endpoints |
| `TABLE-AUDIT-CODE-v1` | `julia/scripts/generate_main_text_tables.jl` | `3349addecd33cb2973bfa4d36b1561a6461a1f790f2150366b909c2082fd6cc9` | exact-source Julia renderer and nonmutating drift gate for every retained main-text table plus the two complete canonical correspondences moved to Appendix D |
...
| `TABLE-MAIN-RANDOMIZED-v1` | `manuscript/tables/main_randomized_optimization_summary.tex` | `3aaae7f57ba0eccf75b0e61b16f032743d23291059c4aa68d5778bb9b0dafbbc` | condensed six-row registered optimization summary with exact fractions/counts and explicitly approximate rendered means |
...
| `TABLE-APP-SAFE-v1` | `manuscript/tables/appendix_canonical_safe_compression.tex` | `b8ef8754d8971db3f3b951be3aaa075d7f323712ff4744b8dc8acb24a010b304` | complete exact canonical safe-compression correspondence moved from the main text to Appendix D |
| `TABLE-APP-RESOURCE-v1` | `manuscript/tables/appendix_canonical_resource_summary.tex` | `681f1c553f924202db6bb12f80c887fc78d428f94829620ade4b23c8743ba40d` | exact canonical capacity paths, optimizer ties, and active switch prices moved from the main text to Appendix D |
