...
\end{equation}
It is the \emph{library component} of the controlled state at embedded
decision epochs. The filtered belief remains part of that state. No new
decision is taken during a committed project. If a calendar-time representation
exposes intermediate observations, it must also retain enough history to
condition the declared joint completion law; project identity and remaining
duration alone need not suffice for an arbitrary path--outcome coupling.
\end{definition}
...
\]
The three defining closure properties give
\begin{equation}
...
generic quotient-minimality claim. Action correspondence concerns Continue and
research-project choices. It does not require retaining every raw strategy
identity that attains the same operating frontier.
