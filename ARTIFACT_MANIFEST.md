...
|---|---|---|---|
| `RO-CORE-v2` | `julia/src/ResourceOptimization.jl` | `b558551fca02f1b1409f1c7be2dacaa45dc5950c67c32ea57befc53b2ccd1715` | v1 exact finite-library burden, safety, capacity, penalty, breakpoint, and supporting-price algebra plus the structural safe-deletion gap generator, bounded exact-oracle materializer, and rechecked deterministic heaviest-safe-first trace; isolation preserves the locked productive package entry point |
...
## AoOR manuscript evidence-input artifacts

Generated by `julia --project=julia julia/scripts/build_aor_manuscript_evidence_inputs.jl --write`
and independently checked against the committed inputs with the corresponding
`--check` command. These are publication inputs, not new experimental results.
