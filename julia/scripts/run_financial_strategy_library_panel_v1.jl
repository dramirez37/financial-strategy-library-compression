...
function _environment(
    ...
    return Dict{String,Any}(
        ...
        "active_amendment_id" => "AMENDMENT_007",
...
function _write_environment(paths)
    execution_lock_aggregate = verify_execution_lock_007()
    if isfile(paths.environment)
        ...
        predecessor_lock_matches =
            get(environment, "execution_lock_aggregate_sha256", "") == LOCK_006_AGGREGATE
        ...
        successor_recovery || error(
            "saved environment belongs to an earlier execution lock outside Amendment 007 recovery",
        )
