...
| M-08 | Finite exhaustive validation is presented as universal proof. | Medium | High | The 6,360 reduction/mask correspondences and other fixture grids are bounded exact computations. | State the searched class and counts. Keep universal claims attached to human or Lean proof only. |
