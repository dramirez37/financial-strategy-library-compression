...
The operating observation is the maximum modeled payoff of one catalog entry.
An entry may already specify a portfolio, but the result does not preserve an
unmodeled allocation across several entries. Such an application requires a
preservation target containing the relevant joint payoff information and
feasible allocations before the factorization argument can be applied.
