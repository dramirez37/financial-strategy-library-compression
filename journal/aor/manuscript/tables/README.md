...
`generated_inputs.tex` inputs only local, generated tables. Replacing an input
requires a source row in `SOURCE_MIGRATION_MANIFEST.csv`, a machine-readable
artifact identifier, and a nonmutating regeneration check.
