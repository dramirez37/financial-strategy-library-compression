...
aor-financial-panel-v1-design-check:
	...
	@"$(JULIA_EXE)" --startup-file=no --project=julia julia/scripts/lock_financial_strategy_library_panel_v1_execution_020.jl --check
...
aor-financial-panel-v1-execution-lock:
	@"$(JULIA_EXE)" --threads=8 --startup-file=no --project=julia julia/scripts/lock_financial_strategy_library_panel_v1_execution_020.jl --check
