...
| S13 | Point-in-time financial and calibrated mechanism records | sealed public-safe point-in-time structural, proposal, and evaluation manifests; sealed calibrated synthetic summaries | Retrospective financial evidence and synthetic mechanism evidence remain distinct. Internal versioned identifiers are retained only for hash provenance; raw licensed rows remain excluded. |
