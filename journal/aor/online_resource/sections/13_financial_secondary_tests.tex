...
\subsection{Journal algorithm comparison and locked weight robustness}
...
The three prospectively locked schedules are equal active-strategy burden,
...
missing-data rules before outcomes. Schedule agreement and the
...
retrospective audits support resource-allocation and governance interpretation,
not causal, forecasting, alpha, or deployable-performance claims.
