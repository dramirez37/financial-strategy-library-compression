...
This section states a conditional representation theorem for a declared
information architecture. The controller observes a filtered belief, operates
...
financial cases in Section~\ref{sec:financial-case-studies} use observed
SPY-signal bins as such rows; they do not estimate the hidden-state filter in
this subsection.
