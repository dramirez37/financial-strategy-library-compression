# SSRN review and submission package
...
**v0.3.1-ssrn**, September 18, 2026. It has not been submitted to SSRN or peer
reviewed. No SSRN identifier or DOI is assigned.

## Upload and metadata

Use the [combined manuscript and supplement](../release/v0.3.1-ssrn/financial-strategy-library-compression-ssrn.pdf).
...
Paste [abstract_for_ssrn.txt](../release/v0.3.1-ssrn/abstract_for_ssrn.txt),
including its AI disclosure paragraph, into the submission abstract field.
Check extracted fields against [submission_metadata.json](../release/v0.3.1-ssrn/submission_metadata.json).
...
The [versioned source archive](../release/v0.3.1-ssrn/financial-strategy-library-compression-ssrn-source.tar.gz)
contains the current document inputs and public evidence.

The [quality review](../release/v0.3.1-ssrn/QUALITY_REVIEW.md) states the checks
actually completed. [SOURCE_MANIFEST.json](../release/v0.3.1-ssrn/SOURCE_MANIFEST.json)
and [SHA256SUMS](../release/v0.3.1-ssrn/SHA256SUMS) bind the source and release.
...
The [full manuscript and supplement review](current/READINESS_REVIEW.md) records
the current disposition. This revision adds three reproducible figures and
repairs mathematical and inferential claim boundaries. Unqualified readiness is
withheld while the repository-wide source-lock failure remains unresolved.
