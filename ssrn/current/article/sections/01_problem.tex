...
which strategies can leave the active library without reducing its best modeled
operating value or losing declared capabilities needed to build future strategies.
...
whole. Figure~\ref{fig:capability-bridge} gives a concrete example.

\input{figures/capability_bridge}
...
that preserves only current operation. The screening policy exercises none of
