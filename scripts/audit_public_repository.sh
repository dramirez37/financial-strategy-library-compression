...
RELEASE_EXCLUDED_PATHS=(
    ...
    AGENTS.md
    APPENDIX_REVISION_LOG.md
    BIBLIOGRAPHY_VERIFICATION.md
    CITATION_LEDGER.md
    DECISIONS.md
    FATAL_OVERLAP_AUDIT_2026.md
    FATAL_OVERLAP_CHECK.md
    FIGURE_AUDIT.md
    FORMAL_PROOF_AUDIT.md
    INTERACTION_THEOREM_DIAGNOSIS.md
    MANUSCRIPT_FOCUS_PAGE_ECONOMY_AUDIT.md
    MANUSCRIPT_REVISION_MAP.md
    NOVELTY_MATRIX.md
    NOVELTY_REFEREE_REPORT_2026.md
    OPTIMIZATION_FORMAL_AUDIT.md
    OPTIMIZATION_MANUSCRIPT_MAP.md
    OPTIMIZATION_REVISION_BASELINE.md
    PREPRINT_BASELINE.md
    PREPRINT_BASELINE_AUDIT.md
    PREPRINT_SECTION5_TRIAGE.md
    PUBLIC_REPOSITORY_AUDIT.md
    REPOSITORY_AUDIT.md
    RESEARCH_PLAN.md
    RESOURCE_RETENTION_RESTRUCTURE_AUDIT.md
    REVISED_NOVELTY_STATEMENT_2026.md
    REVISION_2_BASELINE.md
    REVISION_2_DEPENDENCY_MAP.md
    REVISION_BASELINE.md
    STATUS.md
    SWITCHING_ELASTICITY_SPEC.md
    TABLE_AUDIT.md
    UPDATED_CITATION_LEDGER.md
    UPDATED_CITATION_LEDGER_2026.md
    UPDATED_FORMAL_PROOF_AUDIT.md
    UPDATED_MANUSCRIPT_FORMAL_AUDIT.md
    UPDATED_NOVELTY_MATRIX.md
    UPDATED_NOVELTY_MATRIX_2026.md
    experiments/logs/README.md
    julia/notebooks/README.md
    manuscript/appendices/README.md
    manuscript/bibliography/README.md
    manuscript/build/README.md
