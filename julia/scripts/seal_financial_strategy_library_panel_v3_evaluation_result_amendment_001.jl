module SealFinancialStrategyLibraryPanelV3EvaluationResultAmendment001
...
const Runner = RunFinancialStrategyLibraryPanelV3EvaluationAmendment001
const BaseRunner = Runner.BaseRunner
const AmendmentStage = Runner.AmendmentStage
...
function _payload()
    ...
    return Dict{String,Any}(
        "schema_version" =>
            "financial-strategy-library-panel-v3-evaluation-result-seal-v1-amendment-001",
        ...
        "evaluation_execution_lock_sha256" =>
            _sha256_file(BaseRunner.EXECUTION_LOCK_PATH),
        "evaluation_staging_validator_amendment_001_lock_sha256" =>
            _sha256_file(AmendmentStage.AMENDMENT_LOCK_PATH),
        "evaluation_staging_validator_amendment_001_receipt_sha256" =>
            _sha256_file(AmendmentStage.AMENDMENT_RECEIPT_PATH),
        "proposal_policy_result_seal_sha256" =>
            _sha256_file(BaseRunner.PROPOSAL_RESULT_SEAL_PATH),
        "proposal_robustness_result_seal_sha256" =>
            _sha256_file(BaseRunner.PROPOSAL_ROBUSTNESS_RESULT_SEAL_PATH),
        "evaluation_result_manifest_sha256" =>
            _sha256_file(BaseRunner.PUBLIC_RESULT_MANIFEST_PATH),
        "evaluation_result_local_manifest_sha256" =>
            _sha256_file(BaseRunner.LOCAL_RESULT_MANIFEST_PATH),
...
function main(args = ARGS)
    ...
    if args[1] == "--seal"
        ...
        println("V3_HISTORICAL_EVALUATION_RESULT_SEALED_WITH_AMENDMENT_001")
    elseif args[1] == "--check"
...
if abspath(PROGRAM_FILE) == @__FILE__
    SealFinancialStrategyLibraryPanelV3EvaluationResultAmendment001.main()
end
