...
normalization can use the fixed no-instance with one singleton of cost one
and budget zero in its uncovered-universe branch. It then uses unit costs in
every branch, so the restricted subclass remains NP-complete with unit active
weights. Solving the associated
